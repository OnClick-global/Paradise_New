                ...
                <div class="text-muted font-13">
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="theprofessor" class="form-control" id="username" name="username" readonly>
                        </div>

                        <div class="form-group">
                            <label for="purchase_code">Purchase Code</label>
                            <input type="text" value="theprofessor" class="form-control" id="purchase_key" name="purchase_key" readonly>
                        </div>
