...
{{--loader--}}
<div class="container">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero" style="height: 100%; background-image: url(http://localhost/dashboard/Pentola/Pentola/public/assets/admin/svg/components/login-background.png);">
    </div>
    <div class="row">
        <div class="col-md-12">
