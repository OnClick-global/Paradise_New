                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{\App\CentralLogics\translate('transaction history')}}</a>
                    </li>
            ...
            <div class="table-responsive datatable-custom pt-2">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0">{{\App\CentralLogics\translate('user name')}}</th>
                        <th>{{\App\CentralLogics\translate('description')}}</th>
                        <th>{{\App\CentralLogics\translate('type')}}</th>
                        <th style="width: 100px"
                            class="text-center">{{\App\CentralLogics\translate('amount order')}}</th>
                    </tr>
                    <tr>
                        <th></th>
                        <th></th>
