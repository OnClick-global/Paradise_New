...
@section('title',\App\CentralLogics\translate('Customer List'))
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{\App\CentralLogics\translate('customer list')}}</a>
                    </li>
                    {{--<li class="nav-item">
                        ...
                        <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <span
                                        class="dropdown-header">{{\App\CentralLogics\translate('download options')}}</span>
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span
                                                    class="mr-2">{{\App\CentralLogics\translate('total order')}}</span>
            ...
            <div class="table-responsive datatable-custom">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    <tr>
                        ...
                        <th>{{\App\CentralLogics\translate('total order')}}</th>
                        <th>{{\App\CentralLogics\translate('available points')}}</th>
