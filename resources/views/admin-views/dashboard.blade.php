            ...
            <div class="row gx-2 gx-lg-3 mb-2">
                <div class="col-9">
                    <h4><i style="font-size: 30px"
                           class="tio-chart-bar-4"></i>{{trans('messages.dashboard_order_statistics')}}</h4>
                </div>
                <div class="col-3">
                        ...
                        <div class="row mb-4">
                            <div class="col-12 mb-3 border-bottom">
                                <h5 class="card-header-title float-left mb-2">
                                    ...
                                    {{trans('messages.Earning statistics for business analytics')}}
                                <!-- Legend Indicators -->
                                <h5 class="card-header-title float-right mb-2">  {{trans('messages.Monthly Earning')}}
                            ...
                            <div class="col-md-4 graph-border-1">
                                <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                         ...
                                         {{trans('messages.earnings') }} : {{ array_sum($earning) ." ".\App\CentralLogics\Helpers::currency_symbol() }}
                                      </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-header">
                        <h5 class="card-header-title">
                            <i class="tio-company"></i> {{trans('messages.Total Business Overview')}}
                        </h5>
        ...
        @push('script_2')
            <script>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: [
                            '{{trans('messages.customer')}}  {{$data['customer']}} ',
                            '{{trans('messages.product')}}  {{$data['product']}} ',
                            '{{trans('messages.order')}}   {{$data['order']}} ',
                            '{{trans('messages.category')}}   {{$data['category']}} ',
                            '{{trans('messages.branch')}}   {{$data['branch']}} ',
                        ],
                        datasets: [{
                            label: 'Business',
