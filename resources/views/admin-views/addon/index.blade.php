                            ...
                            <div class="col-6">
                                @foreach (json_decode($language) as $lang)
                                    <div class="form-group {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        ...
                                        <input type="text" name="name[]" class="form-control" placeholder=" {{\App\CentralLogics\translate('Add new addon')}}"
                                ...
                                @else
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group lang_form" id="{{ $default_lang }}-form">
                                                ...
                                                <input type="text" name="name[]" class="form-control"
                                                       placeholder=" {{\App\CentralLogics\translate('Add new addon')}}" required>
                                            </div>
                                        ...
                                        <div class="col-6 from_part_2">
                                            ...
                                            <input type="number" min="0" name="price" step="0.01" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                            </div>
                        </div>
