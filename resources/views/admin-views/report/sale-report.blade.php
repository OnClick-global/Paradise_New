                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{\App\CentralLogics\translate('sale report overview')}}</h1>
                        ...
                        <form action="javascript:" id="search-form" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt-4">
                                    <strong>
                                        {{\App\CentralLogics\translate('total orders')}} : <span
                                            id="order_count"> </span>
                                    </strong><br>
                                    <strong>
                                        {{\App\CentralLogics\translate('total item qty')}}
                                        : <span
                                            id="item_count"> </span>
                                    </strong><br>
                                    <strong>{{\App\CentralLogics\translate('total amount')}} : <span
