                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0 text-capitalize">
                            <h1 class="page-header-title">{{\App\CentralLogics\translate('earning report overview')}}</h1>
            ...
            <div class="col-lg-12 pt-3">
                <form action="{{route('admin.report.set-date')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">{{\App\CentralLogics\translate('show data')}} by {{\App\CentralLogics\translate('date')}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{\App\CentralLogics\translate('total tax')}}</h4>
