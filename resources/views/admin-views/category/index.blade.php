...
@section('title',\App\CentralLogics\translate('New Category'))
                            ...
                            <div class="col-6">
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-6" >
                                            <label for="catColor" class="">{{\App\CentralLogics\translate('Select background Color')}}:</label>
                                            <input type="color" id="catColor" value="#abdee8" name="catColor"><br><br>
                                        </div>
                                        <div class="col-6" >
                                            <label for="catColor" class="">{{\App\CentralLogics\translate('Select text Color')}}:</label>
                                            <input type="color" id="textColor" value="#000000" name="textColor"><br><br>
                                        </div>
