...
@section('title',\App\CentralLogics\translate('New subCategory'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('add.new.sub_category')}}
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                @foreach(json_decode($language) as $lang)
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                        ...
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CentralLogics\translate('sub_category')}} {{\App\CentralLogics\translate('name')}}
                                            ({{strtoupper($lang)}})</label>
                                        <input type="text" name="name[]" class="form-control"
                                               placeholder="{{\App\CentralLogics\translate('add.new.sub_category')}}" {{$lang == $default_lang? 'required':''}}>
                                    </div>
                                ...
                                @else
                                        ...
                                        <div class="col-6">
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label class="input-label"
                                                    ...
                                                    ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" class="form-control"
                                                       placeholder="{{\App\CentralLogics\translate('add.new.sub_category')}}"
                                                       required>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <label for="catColor" class="">{{\App\CentralLogics\translate('Select Color')}}
                                            :</label>
                                        <input type="color" id="catColor" name="catColor"><br><br>
                                    </div>
                            </div>
                        </div>
                        <button type="submit"
