                    ...
                    <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('opening time')}}</label>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('closing time')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('product and category translation')}}</label>
                                ...
                                <div class="card">
                                    <div class="card-body" style="padding: 20px">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <label
                                                style="padding-left: 10px">{{\App\CentralLogics\translate('default delivery charge')}}</label>
                                            <br>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label style="padding-left: 10px">{{\App\CentralLogics\translate('minimum shipping charge')}}</label>
                                        ...
                                        <div class="form-group mb-2">
                                            <label style="padding-left: 10px">{{\App\CentralLogics\translate('shipping charge kilometer')}}</label>
