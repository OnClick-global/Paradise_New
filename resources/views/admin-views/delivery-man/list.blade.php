        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{\App\CentralLogics\translate('deliveryman list')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.delivery-man.add')}}" class="btn btn-primary pull-right"><i
                                class="tio-add-circle"></i> {{\App\CentralLogics\translate('Add new delivery-man')}}</a>
                    </div>
                    <!-- End Header -->
