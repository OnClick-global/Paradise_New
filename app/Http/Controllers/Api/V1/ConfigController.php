...
class ConfigController extends Controller
{
    public function configuration()
    {
        ...
        $openTime  = date('Y-m-d H:i:s',strtotime(BusinessSetting::where(['key' => 'restaurant_open_time'])->first()->value.'-1 day'));
        $closeTime = date('Y-m-d H:i:s',strtotime(BusinessSetting::where(['key' => 'restaurant_close_time'])->first()->value.'+1 day'));
        return response()->json([
            ...
            'is_open' => Helpers::isBetween($openTime,$closeTime,date('Y-m-d H:i:s')),
            ...
            'maintenance_text_ar' => "يتم الأن العمل على صيانة التطبيق وسوف يكون متاح فى اقرب وقت ممكن ",
            'maintenance_text_en' => "The application is currently being maintained and will be available as soon as possible",
