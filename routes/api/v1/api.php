...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    // paymob method
    Route::get("/payment/{id}/{user_id}", "OrderController@DoPayment");
    Route::post("/payment/show/phone_page/{payway}/{id}/{user_id}", "OrderController@show_phone_page")->name('show_phone_page');
    Route::post("/payment/{payway}/{id}/{user_id}", "OrderController@payway")->name('payWay');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('newlist', 'ProductController@newlist');
        Route::get('more/{category}/{offset}', 'ProductController@more');
        Route::get('discount', 'ProductController@get_discounted_product');
