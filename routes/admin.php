...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/sendMessageTo/{id}', 'ConversationController@NewMassage')->name('NewMassage');
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.'], function () {
            ...
            Route::get('recipt', 'ReportController@earning_recipt')->name('recipt');
            Route::get('earning', 'ReportController@earning_index')->name('earning');
            Route::post('set-date', 'ReportController@set_date')->name('set-date');
            Route::post('printrecipt', 'ReportController@printrecipt')->name('printrecipt');
